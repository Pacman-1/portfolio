...
return (
    ...
    <section className="skillSection">
        <CardCase cardName="Full Stack Development" description="For me, it's important to know all sides of the web development process. I'll learn whatever technology is needed for me to build the applications i'm working on." image="fa-solid fa-code"/>
